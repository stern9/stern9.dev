...
const NowPlaying = () => {
  ...
  return (
    <div className="flex flex-row sm:flex-row space-x-0 sm:space-x-2 justify-center ">
      ...
      <div className="inline-flex flex-col sm:flex-row w-full max-w-full pl-2 sm:pl-0 truncate">
        {data?.songUrl ? (
          <a
